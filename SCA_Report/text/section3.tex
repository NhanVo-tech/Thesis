...
Trạng thái $(x, y, v_x, v_y)$ sau khi đi qua bộ lọc Kalman hai chiều (EKF) sẽ được bàn giao cho module \texttt{AccessController} để thực hiện quyết định truy cập hình học, đồng thời được đưa vào module \texttt{LstmInference}. Tại đây, một cửa sổ trượt (Sliding Window) lưu trữ $25$ khung hình gần nhất sẽ thực hiện tính toán đặc trưng và suy luận ngay trên vi điều khiển (On-device Inference). Quy trình ra quyết định được thực hiện qua hai lớp bảo mật:
