...
\begin{itemize}
    ...
    \item \textbf{Định vị Trilateration và Bộ lọc Hysteresis mở cửa:} Module \texttt{Trilateration} hợp nhất ba khoảng cách thành tọa độ $(x, y)$, bộ lọc Kalman hai chiều (EKF) làm mượt quỹ đạo, và module \texttt{AccessController} áp dụng màng lọc độ trễ trạng thái trên khoảng cách Euclid đến điểm mở khóa. Rơ-le chỉ mở khi liên tiếp 3 chu kỳ đều cho khoảng cách an toàn đồng thời cổng vận tốc hướng tâm xác nhận người dùng đang tiến lại gần, triệt tiêu hoàn toàn hiện tượng rơ-le đóng/ngắt liên tục do dao động sóng.
\end{itemize}
